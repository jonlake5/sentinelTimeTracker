...
$data = Import-Excel -Path $CONTENT_FILE  -AsText "Date"  -WorksheetName 'Time Tracking' -Verbose -StartColumn 1 -EndColumn 11 -StartRow 1 -StopRow 1000  | Where-Object { $_.Date } 
