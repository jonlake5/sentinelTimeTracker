...
(() => {
  ...
  const fieldSelectors = {
    ...
    company: [
      ...
      'input[id="sys_display.x_st_sti_tab_daily_time.company"]',
      // 'select[name*="company"]',
      // 'input[name*="company"]',
    ...
    projectActivity: [
      ...
      'select[id="x_st_sti_tab_daily_time.project_activity"]',
    ...
    shortDescription: [
      ...
      // 'text[id="x_st_sti_tab_daily_time.shortdescription"]',
    ...
    businessUnit: [
      ...
      // 'select[name="x_st_sti_tab_daily_time.business_unit"]',
      // 'input[name="x_st_sti_tab_daily_time.business_unit"]',
      // 'select[id="x_st_sti_tab_daily_time.business_unit"]',
      // 'input[id="x_st_sti_tab_daily_time.business_unit"]',
      // 'select[name*="business_unit"]',
      // 'input[name*="business_unit"]',
      // 'select[aria-label*="business_unit"]',
      // 'input[aria-label*="business_unit"]',
    ],
  };
