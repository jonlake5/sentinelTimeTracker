...
(() => {
  ...
  const fieldSelectors = {
    date: ['input[id="x_st_sti_tab_daily_time.workdate"]'],
    showTimeAs: ['select[id="x_st_sti_tab_daily_time.showtimeas"]'],
    location: ['select[id="x_st_sti_tab_daily_time.location"]'],
    company: ['input[id="sys_display.x_st_sti_tab_daily_time.company"]'],
    projectName: [
      'input[id="sys_display.x_st_sti_tab_daily_time.projectnumber"]',
    ],
    projectActivity: ['select[id="x_st_sti_tab_daily_time.project_activity"]'],
    shortDescription: ['input[id="x_st_sti_tab_daily_time.shortdescription"]'],
    detailedDescription: [
      'textarea[id="x_st_sti_tab_daily_time.detaileddescription"]',
    ],
    startTime: ['select[id="x_st_sti_tab_daily_time.regularstart"]'],
    endTime: ['select[id="x_st_sti_tab_daily_time.regularstop"]'],
    businessUnit: [
      'input[id="sys_display.x_st_sti_tab_daily_time.business_unit"',
    ],
  };
